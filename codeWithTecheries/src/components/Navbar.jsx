            ...
            <nav className='bg-white p-4 w-full dark:bg-gray-950 sticky top-0 z-[999]'>
                <div className='max-w-6xl mx-auto flex items-center justify-between'>
                    ...
                    <div className='hidden md:flex items-center space-x-4'>
                        <NavLink  className={({isActive}) => `text-gray-800 dark:text-gray-300 hover:text-yellow-500 ${isActive ? 'text-yellow-500 dark:text-yellow-500' : ''}`}>Home</NavLink>
                        ...
                        <NavLink  className={({isActive}) => `text-gray-800 dark:text-gray-300 hover:text-yellow-500 ${isActive ? 'text-yellow-500 dark:text-yellow-500' : ''}`}>Resources</NavLink>
                    </div>

                    {/* Center - visible on all screens */}
                    <NavLink className='flex items-center space-x-4'>
                        <img src="./logo/cwtLogo-animatedColor.svg" alt="site-logo" className='w-8 h-8 sm:w-10 sm:h-10' />
                    </NavLink>
